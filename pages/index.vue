    ...
    <div class="row">
      <div class="col-1-of-2">
        ...
        <p class="paragraph">
          ...
          consequatur rem repudiandae optio itaque! Cupiditate libero possimus
          asperiores aperiam, nulla sunt quaerat deleniti sint accusamus
          laudantium praesentium.
        </p>

        <h3 class="heading-tertiary u-margin-bottom-small">
          Live adventures like you nver have before
        </h3>
        <p class="paragraph">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Numquam
          delectus beatae ducimus quo cupiditate quod exercitationem, pariatur
          accusantium.
        </p>
      ...
      <div class="col-1-of-4">
        <div class="feature-box">
          ...
          <p class="feature-box__text">
            ...
            excepturi est commodi quibusdam?
          </p>
        </div>
      </div>
      <div class="col-1-of-4">
